...
if __name__ == '__main__':
    ...
    TOP.configure(background="#FFEBCD")
    TOP.title("BMI Calculator")
    TOP.resizable(width=False, height=False)
    LABLE = Label(TOP, bg="#DEB887", text="Welcome to BMI Calculator", font=("Helvetica", 15, "bold"), pady=10)
    ...
    BUTTON = Button(bg="#A52A2A", bd=12, text="BMI", padx=33, pady=15, command=calculate_bmi,
